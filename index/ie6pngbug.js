...
//DD_belatedPNG.fix('img,i,.i-logo,.i-title,.point-arrow-top, .oper-add, .oper-delete, .oper-change, .oper-inthered, .oper-up, .oper-down,.abs-arr');
    DD_belatedPNG.fix('.ic-b2a,.ic-a2a,.ic-a2b,.content_name .icon-lt,.content_name .icon-valid-manage,.caseorgBody i,.lt-rz-nav i,.accordion-main i,#Message i,.brand,.i-logo,.i-title,.point-arrow-top, .oper-add, .oper-delete, .oper-change, .oper-inthered, .oper-up, .oper-down,.abs-arr,.talk-main-delete-right,.talk-main-delete-left,.talkMain_part_r,.talkMain_part_l,.topTab img,.icon-comment,.icon-addPs,.icon-file,.icon-camera,.icon-th-large,.icon-chevron-up,.icon-chevron-down,.abs-move,#closeIcon img');
}
